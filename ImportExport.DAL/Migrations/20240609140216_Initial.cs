    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Alexanderplatz 1", "Berlin", "Germany" },
            ...
            migrationBuilder.InsertData(
                table: "Dealers",
                columns: new[] { "ID", "Email", "LocationID", "Name", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, "rpm@info.com", 1, "RPM Cars", "8395994874" },
                    { 2, "autohaus@example.com", 2, "AutoHaus", "1234567890" },
                    { 3, "carcenter@example.com", 3, "CarCenter", "0987654321" },
                    { 4, "carworld@example.com", 4, "CarWorld", "5555555555" }
                });
